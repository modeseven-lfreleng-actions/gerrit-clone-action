...
class CloneWorker:
    ...
    def _perform_clone(
        ...
        try:
            ...
            # whoever put it there.  Asked before the late ancestor check
            # rather than after it, because that check can write nested
            # protection into a parent repository, and on a retry this
            # runs after a delay in which the batch may have given up.
